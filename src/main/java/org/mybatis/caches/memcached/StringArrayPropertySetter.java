 ...
 */
final class StringArrayPropertySetter extends AbstractPropertySetter<String[]> {
     ...
     */
    public StringArrayPropertySetter(final String propertyKey, final String propertyName, final String[] defaultValue) {
